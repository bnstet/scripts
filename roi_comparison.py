...
neurofinderList = ['/gpfs/data/shohamlab/ben/segmentation_project/neurofinder/data/neurofinder.03.00/',
...
'/gpfs/data/shohamlab/ben/segmentation_project/neurofinder/data/neurofinder.00.00/']
neurofinderList = [str(list(Path(x).rglob('regions.json'))[0]) for x in neurofinderList ]


caimanList = ['/gpfs/data/shohamlab/ben/segmentation_project/neurofinder/data/neurofinder.03.00/images/caiman_output.npz',
...
'/gpfs/data/shohamlab/ben/segmentation_project/neurofinder/data/neurofinder.00.00/images/caiman_output.npz' ]

suite2pList = [6,5,3,7,4,1,2,0]
...
neurofinderCells = [tp.loadNeurofinderRegions(x, vidDims[1,2]) for x in neurofinderList]
